...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Retorna todos as experiências curriculares', type: experience_entity_1.Experience, isArray: true }),
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Cria uma nova experiência', type: experience_entity_1.Experience }),
